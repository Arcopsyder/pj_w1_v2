...
insert overwrite qfbap_dwd.dwd_biz_trade partition(dt)
select 
trade_id,
order_id,
user_id,
...
insert overwrite qfbap_dwd.dwd_cart partition(dt)
select
cart_id,
session_id,
user_id,
...
insert overwrite qfbap_dwd.dwd_order_delivery partition(dt)
select
order_id,
order_no,
consignee,
...
insert overwrite qfbap_dwd.dwd_order_item partition(dt)
select
user_id,
order_id,
order_no,
